...
-- lazy.lua (for plugin installation)
return {
  -- nvim-cmp: completion engine
  {
    ...
    dependencies = {
      ...
      "tailwindlabs/tailwindcss-intellisense.nvim", -- Tailwind CSS LSP
    },
    config = function()
      ...
      cmp.setup({
        snippet = {
          expand = function(args)
            vim.fn["vsnip#anonymous"](args.body) -- Expand snippets
          end,
        },
        mapping = {
      ...
      -- Ensure LSP capabilities for nvim-cmp
